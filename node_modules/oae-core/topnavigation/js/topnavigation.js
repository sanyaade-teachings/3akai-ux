...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        /**
         * Initialize the main top navigation container
         */
        var initContainer = function() {
            var landingPage = ((window.location.pathname === '/') || (window.location.pathname === '/index'));
            oae.api.util.template().render('#topnavigation-template', {landingPage: landingPage}, $('#topnavigation-container', $rootel));
        };
        ...
        var initRightMenu = function() {
            ...
            // Render login/logout
            oae.api.util.template().render($template, null, $('#topnavigation-loginlogout-container', $rootel));
        };
        ...
        var setUpPushNotifications = function() {
            if (!oae.data.me.anon) {
                oae.api.push.subscribe(oae.data.me.id, 'notification', oae.data.me.signature, 'activitystreams', true, function(activity) {
                    ...
                    $('#topnavigation-notification-count', $rootel).text(oae.data.me.notificationsUnread).show();
                    ...
                    if ($('.oae-trigger-notifications + .popover:visible', $rootel).length === 0) {
                        var notificationBody = oae.api.util.template().render($('#topnavigation-push-notification-summary', $rootel), {'activity': activity});
        ...
        var setUpSearch = function() {
            if (oae.data.me.anon) {
                $('#topnavigation-container', $rootel).addClass('topnavigation-logged-out');
            }
