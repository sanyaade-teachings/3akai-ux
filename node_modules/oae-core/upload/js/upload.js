...
define(['jquery', 'oae.core', 'jquery.fileupload', 'jquery.iframe-transport', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid) {
        ...
        var updateProgress = function(progress) {
            $('.progress-bar', $rootel).css('width', progress + '%');
            $('.progress-bar', $rootel).attr('aria-valuenow', Math.round(progress) + '%');
        };
        ...
        var setUpUploadModal = function() {
            // Hide the drag and drop text when on mobile
            if (oae.api.util.isHandheldDevice()) {
                $('#upload-drop-text', $rootel).hide();
            }
            ...
            $('#upload-change-permissions', $rootel).on('click', showPermissions);
