            ...
            $(document).on('click', '.oae-trigger-share', function() {
                ...
                oae.api.util.clickover($trigger, $('.share-widget'), {
                    'onShown': function($currentRootEl) {
                        ...
                        // Work around a Chrome bug (https://code.google.com/p/chromium/issues/detail?id=268718) where
                        // it sometimes forgets to update z-index by forcing a repaint. Without the workaround the share
                        // popover will be displaybed behind a content preview that uses an iframe.
                        // @see https://github.com/oaeproject/3akai-ux/pull/3436
